...
<html>
	...
	<div class="imglog">
		<div class="trans"><center class="formtitle"><span>S</span>how Transactions<center><br>
		<form action="" method="post">
		<table class='fitted'> 
		<tr>
			<td>Employee ID:</td><td><input type="numeric" name="EID"></td><td>Date:</td><td><input type="date" name="date"></td><td><input type="submit" name="show" value="Show"></td>
		</tr>
		</table>		
		</form>
