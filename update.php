...
if($status=="disp")
{
		...
		<table style="font-size: 14px; border: 1px solid black; border-collapse: collapse;">
			<tr>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">EID</th>
			<th  style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Pass</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Name</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Addr</th>
			<th  style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Cont</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Sec</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Shift</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">GID</th>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">Sal</th>
