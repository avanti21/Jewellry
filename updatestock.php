...
if($status=="disp")
{
		...
		<table style="font-size: 14px; border: 1px solid black; border-collapse: collapse;">
			<tr>
			<th style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">JID</th>
			<th  style="border: 1px solid black; font-size: 15px; color: Maroon; padding: 5px;">TOJ</th>
